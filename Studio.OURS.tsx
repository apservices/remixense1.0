      ...
      <div className="sticky top-0 z-40 glass border-b border-glass-border backdrop-blur-glass">
        <div className="px-4 py-6">
          ...
          <p className="text-muted-foreground text-sm">
            An├ílise avan├ºada, mixagem inteligente e performance profissional
          </p>
        </div>
      </div>
                ...
                {selectedTrack ? (
                  ...
                  <Card className="glass border-glass-border p-12 text-center">
                    ...
                    <h3 className="text-heading-lg text-foreground mb-2">
                      An├ílise Inteligente de Faixas
                    </h3>
                    <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                      Selecione uma faixa da sua biblioteca para ver an├ílise espectral completa, 
                      caracter├¡sticas de mixagem e propriedades avan├ºadas.
                    </p>
                    {filteredTracks.length > 0 && (
                      <Button
                        variant="neon"
